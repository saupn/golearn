...
class MockLeaderboardRepository implements LeaderboardRepository {
  ...
  @override
  Future<List<LeaderboardEntry>> getLeaderboard(String boardId, {int limit = 100}) async {
  ...
  @override
  Future<LeaderboardEntry?> getUserPosition(String boardId, String userId) async {
